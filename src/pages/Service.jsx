                ...
                <article className='pages-container'>
                    <div className="service-row row row-cols-1 row-cols-md-3 g-3">
                        <div className="service-body col">
                            <div className="card">
                                <div className='Service_img'>
                                    <svg className="bi bi-brush svg-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 16 16">
                        ...
                        <div className="service-body col">
                            <div className="card">
                                <div className='Service_img'>
                                    <svg className="bi bi-code-slash svg-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 16 16">
                        ...
                        <div className="service-body col">
                            <div className="card">
                                <div className='Service_img'>
                                    <svg className="bi bi-search svg-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 16 16">
